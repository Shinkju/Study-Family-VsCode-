...
function StudentUpdate(){
    ...
    const onClickModifyModeHandler = () => {
        ...
        setForm({
            ...
            departmentCode : studentDetail.departmentCode,
            ...
            schoolStatusCode : studentDetail.schoolStatusCode
        });
    }
    ...
    const onClickStudentUpdateHandler = () => {
        ...
        navigate(`/student/${studentDetail.student.studentNo}`, { replace : true });
